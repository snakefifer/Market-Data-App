...
print(fetch_yfinance_data(tickers_indexes, format_index_price))
print(fetch_yfinance_data(tickers_forex, format_forex_price))
print(fetch_yfinance_data(tickers_crypto, format_crypto_price))
print(fetch_yfinance_data(tickers_treasury, format_treasury_price))
print(fetch_yfinance_data(tickers_commodities, format_commodity_price))
print(fetch_fed_data())